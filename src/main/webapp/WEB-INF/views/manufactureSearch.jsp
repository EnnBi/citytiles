...
<div class="col-12 grid-margin">
	<div class="card">
		<div class="card-body">
			...
			<form:form action="/manufacture/search" class="form-sample"
				...
				<table class="table table-striped">
					...
					<c:forEach items="${manufactures}"  var="manufacture"> 
						<tr>
							...
							<td><a href="/manufacture/edit/${manufacture.id}"
									class="btn btn-success btn-fw" style="margin-right: 5px">Edit</a><a
									href="/manufacture/delete/${manufacture.id}"
			...
			<ul
				...
				<c:if test="${currentPage !=1}">
					<li class="page-item"><a class="page-link"
						href="/manufacture/pageno=${currentPage - 1}"><i
