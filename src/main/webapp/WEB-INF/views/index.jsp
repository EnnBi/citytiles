              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="/resources/images/faces/face4.jpg" alt="">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="/resources/images/faces/face5.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="/resources/images/faces/face7.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                  ...
                  <div class="list d-flex align-items-center pt-3">
                    <img class="img-sm rounded-circle" src="/resources/images/faces/face6.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="wrapper border-bottom py-2">
                        <div class="d-flex">
                          <img class="img-sm rounded-circle" src="/resources/images/faces/face2.jpg" alt="">
                    ...
                    <div class="col-12">
                      <div class="wrapper border-bottom py-2">
                        <div class="d-flex">
                          <img class="img-sm rounded-circle" src="/resources/images/faces/face1.jpg" alt="">
                          <div class="wrapper ml-4">
                    ...
                    <div class="col-12">
                      <div class="wrapper border-bottom py-2">
                        <div class="d-flex">
                          <img class="img-sm rounded-circle" src="/resources/images/faces/face3.jpg" alt="">
                          <div class="wrapper ml-4">
          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="wrapper d-flex align-items-center justify-content-start justify-content-sm-center">
                    <img class="img-md rounded" src="/resources/images/faces/face1.jpg" alt="">
                    <div class="wrapper ml-4">
            ...
            <div class="col-md-4 grid-margin">
              <div class="card">
                <div class="card-body">
                  <div class="wrapper d-flex align-items-center justify-content-start justify-content-sm-center">
                    <img class="img-md rounded" src="/resources/images/faces/face2.jpg" alt="">
                    <div class="wrapper ml-4">
            ...
            <div class="col-md-4 grid-margin">
              <div class="card">
                <div class="card-body">
                  <div class="wrapper d-flex align-items-center justify-content-start justify-content-sm-center">
                    <img class="img-md rounded" src="/resources/images/faces/face3.jpg" alt="">
                    <div class="wrapper ml-4">
