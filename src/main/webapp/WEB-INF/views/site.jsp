	...
	<div class="card">
       ...
       <c:choose>
			...
			<input type="hidden" name="p" value="${currentPage}"/>
				<p class="card-description">Site</p>
				<div class="row">
					<div class="col-md-6">
	            ...
	            <nav aria-label="Page navigation example">
				  <ul class="pagination">
					  <c:if test="${currentPage !=1}">  
					    <li class="page-item"><a class="page-link" href="/site/pageno=${currentPage - 1}">Previous</a></li>
					  </c:if>
						  	...
						  	<c:choose>
								...
								<c:otherwise>
										<li class="page-item"><a class="page-link" 
											href="<c:url value="/site/pageno=${i}"/>"        
											>${i}</a></li>
								</c:otherwise>
							</c:choose>				   
					  </c:forEach>
					  <c:if test="${currentPage!= totalPages}">
					    	<li class="page-item"><a class="page-link" href="/site/pageno=${currentPage + 1}">Next</a></li>
					  </c:if>
				  </ul>
				</nav>
				</c:if>          
